...
export default function Octopus(props) {
  return (
    <svg width="900px" height="873px" viewBox="0 0 900 873" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxlink="http://www.w3.org/1999/xlink" {...props}>
      <desc>Created with Sketch.</desc>
      <defs>
        <lineargradient x1="59.4792517%" y1="57.1915848%" x2="18.0841466%" y2="1.60000684%" id="linearGradient-1">
          <stop stopcolor="#FFFFFF" offset="0%" />
          <stop stopcolor="#1C0F10" offset="100%" />
        </lineargradient>
        <polygon id="path-2" points="161.568317 21.7981651 190.885149 0 196.748515 7.9266055 170.689109 33.6880734" />
        <filter x="-7.1%" y="-7.4%" width="114.2%" height="114.8%" filterUnits="objectBoundingBox" id="filter-3">
          ...
          <fecolormatrix values="0 0 0 0 0.109803922   0 0 0 0 0.0588235294   0 0 0 0 0.062745098  0 0 0 0.5 0" type="matrix" in="shadowInnerInner1" />
        </filter>
        <path d="M161.568317,16.5137615 L0,144.66055 C0,144.66055 3.1496346,151.746494 8.46930693,158.53211 C13.7889793,165.317726 20.1960396,169.761468 20.1960396,169.761468 L175.90099,33.6880734 C175.90099,33.6880734 171.679978,27.1889894 169.386139,24.440367 C167.0923,21.6917446 161.568317,16.5137615 161.568317,16.5137615 Z" id="path-4" />
        <filter x="-12.5%" y="-14.4%" width="125.0%" height="128.7%" filterUnits="objectBoundingBox" id="filter-6">
          ...
          <fecomposite in="shadowOffsetInner1" in2="SourceAlpha" operator="arithmetic" k2={-1} k3={1} result="shadowInnerInner1" />
          <fecolormatrix values="0 0 0 0 0.109803922   0 0 0 0 0.0588235294   0 0 0 0 0.062745098  0 0 0 0.86865942 0" type="matrix" in="shadowInnerInner1" result="shadowMatrixInner1" />
          <femorphology radius={1} operator="erode" in="SourceAlpha" result="shadowSpreadInner2" />
          <fegaussianblur stdDeviation={9} in="shadowSpreadInner2" result="shadowBlurInner2" />
          <feoffset dx={25} dy={-15} in="shadowBlurInner2" result="shadowOffsetInner2" />
          <fecomposite in="shadowOffsetInner2" in2="SourceAlpha" operator="arithmetic" k2={-1} k3={1} result="shadowInnerInner2" />
          <fecolormatrix values="0 0 0 0 0.109803922   0 0 0 0 0.0588235294   0 0 0 0 0.062745098  0 0 0 0.805734828 0" type="matrix" in="shadowInnerInner2" result="shadowMatrixInner2" />
          <femerge>
        ...
        <filter x="-3.7%" y="-1.6%" width="107.4%" height="103.3%" filterUnits="objectBoundingBox" id="filter-21">
          ...
          <fecomposite in="shadowOffsetInner1" in2="SourceAlpha" operator="arithmetic" k2={-1} k3={1} result="shadowInnerInner1" />
          <fecolormatrix values="0 0 0 0 0.0705882353   0 0 0 0 0.0352941176   0 0 0 0 0.0431372549  0 0 0 1 0" type="matrix" in="shadowInnerInner1" />
        </filter>
        <path d="M105.742,327.166667 C109.564,327.166667 123.052573,308.634221 122.304,262.166667 C121.03,183.083333 19.11,52 12.74,52 C6.37,52 1.274,52 1.274,52 C1.274,52 44.0825435,102.367673 52.234,128.916667 C60.3854565,155.46566 52.234,254.583333 52.234,254.583333 L89.18,292.5 C89.18,292.5 101.92,327.166667 105.742,327.166667 Z" id="path-22" />
        ...
        <filter x="-4.3%" y="-9.1%" width="108.7%" height="118.2%" filterUnits="objectBoundingBox" id="filter-25">
          ...
          <feoffset dx={0} dy={0} in="shadowBlurInner1" result="shadowOffsetInner1" />
          <fecomposite in="shadowOffsetInner1" in2="SourceAlpha" operator="arithmetic" k2={-1} k3={1} result="shadowInnerInner1" />
          <fecolormatrix values="0 0 0 0 0.137254902   0 0 0 0 0.0588235294   0 0 0 0 0.0745098039  0 0 0 1 0" type="matrix" in="shadowInnerInner1" result="shadowMatrixInner1" />
          ...
          <fecomposite in="shadowOffsetInner2" in2="SourceAlpha" operator="arithmetic" k2={-1} k3={1} result="shadowInnerInner2" />
          <fecolormatrix values="0 0 0 0 0.137254902   0 0 0 0 0.0588235294   0 0 0 0 0.0745098039  0 0 0 1 0" type="matrix" in="shadowInnerInner2" result="shadowMatrixInner2" />
          <femerge>
            <femergenode in="shadowMatrixInner1" />
            <femergenode in="shadowMatrixInner2" />
          </femerge>
        ...
        <filter x="-1.5%" y="-7.8%" width="102.9%" height="115.7%" filterUnits="objectBoundingBox" id="filter-29">
          ...
          <feoffset dx={0} dy={0} in="shadowBlurInner1" result="shadowOffsetInner1" />
          <fecomposite in="shadowOffsetInner1" in2="SourceAlpha" operator="arithmetic" k2={-1} k3={1} result="shadowInnerInner1" />
          <fecolormatrix values="0 0 0 0 0.137254902   0 0 0 0 0.0588235294   0 0 0 0 0.0745098039  0 0 0 0.68 0" type="matrix" in="shadowInnerInner1" />
        </filter>
      ...
      <g id="Page-1" stroke="none" strokewidth={1} fill="none" fillrule="evenodd">
        <g id="octopus" transform="translate(2.000000, 87.000000)">
          <g id="reflection" transform="translate(199.000000, 609.000000)" fillrule="nonzero">
            <path d="M251.582,0.272 C390.478,0.272 503.078,39.698 503.078,88.332 C503.078,136.966 390.478,176.392 251.582,176.392 C112.685,176.392 0.086,136.966 0.086,88.332 C0.086,39.698 112.685,0.272 251.582,0.272 Z" id="blob" fill="#79DAF1" />
            <path d="M197.038,174.389 C197.031,156.474 197.025,143.245 197.025,143.316 C196.577,104.009 185.344,97.037 179.651,90.468 C179.631,90.421 179.606,90.378 179.586,90.332 L179.553,90.351 C179.587,90.39 179.618,90.429 179.652,90.468 C182.431,96.915 183.851,104.576 183.3,113.65 L183.259,173.183 C168.508,171.731 154.311,169.817 140.792,167.493 C140.793,142.185 140.811,117.183 140.875,117.119 C135.868,71.187 109.23,83.51 107.707,66.965 C103.334,57.346 157.172,53.983 176.583,84.648 C176.585,84.659 176.588,84.667 176.589,84.676 L176.597,84.673 C176.592,84.664 176.588,84.656 176.582,84.648 C176.292,83.021 176.35,81.108 176.871,78.69 C178.579,64.61 243.074,79.562 241.768,140.514 L241.962,176.397 C226.594,176.194 211.581,175.513 197.038,174.389 Z" id="reflectionL" fill="#55BAE8" />
          </g>
          ...
          <g id="tail" transform="translate(155.000000, 414.000000)" fillrule="nonzero">
            <path d="M73.492,35.142 C111.712,110.962 188.233,69.131 188.233,69.131 C195.39,88.192 185.462,128.342 185.462,128.342 C185.462,128.342 84.076,158.629 53.863,71.156 C37.869,24.31 -2.442,19.994 1.897,7.185 C16.979,-9.343 56.689,9.449 73.492,35.142 Z" id="tailBody" fill="#000000" />
            <ellipse id="tdot" fill="#BEE8DE" cx="170.836" cy="87.21" rx="7.625" ry="5.29" />
            <g id="tdot-link" transform="translate(139.500000, 85.000000)" fill="#BEE8DE">
              <ellipse id="tdot" cx="7.836" cy="6.21" rx="7.625" ry="5.29" />
            </g>
          ...
          <g id="head">
            ...
            <circle id="nose" fill="#C35D51" fillrule="nonzero" cx="445.211" cy="350.875" r="10.875" />
            <path d="M424.586,377.167 C424.586,377.167 431.169,390.834 445.211,390.834 C459.253,390.834 465.753,377.167 465.753,377.167" id="mouth" stroke="#C35D51" strokewidth={8} strokelinecap="round" strokelinejoin="round" />
            <g id="whiskers" transform="translate(0.000000, 318.000000)" strokelinecap="round" stroke="#000000" strokewidth={4}>
              <g id="whiskersR" transform="translate(693.000000, 0.000000)">
                <path d="M202.086,14 C202.086,14 124.414,-4.106 6.324,1.943" id="Shape" />
                <path d="M199.317,48.279 C199.317,48.279 118.212,23.432 0,20.661" id="Shape" />
              </g>
        ...
        <g id="sherlock_costume-" transform="translate(90.000000, 0.000000)">
          <g id="magnifying_glass" transform="translate(0.000000, 315.000000)">
            <g id="handle" transform="translate(0.000000, 118.238532)">
              ...
              <g id="Mask">
                <use fill="#663931" fillrule="evenodd" xlinkhref="#path-4" />
            ...
            <ellipse id="inner_glass" stroke="#979797" strokewidth={4} fillopacity="0.389999986" fill="#107BE3" cx="252.450495" cy="77.6146789" rx="67.4287129" ry="68.3669725" />
          </g>
          ...
          <g id="hat" transform="translate(42.000000, 0.000000)">
            ...
            <g id="Path-5" transform="translate(0.000000, 11.916667)">
              ...
              <g id="Path-3-Copy-2" mask="url(#mask-18)" transform="translate(61.803984, 189.583333) scale(-1, 1) translate(-61.803984, -189.583333) ">
                <use fill="url(#linearGradient-19)" fillrule="evenodd" xlinkhref="#path-22" />
                <use fill="black" fillopacity={1} filter="url(#filter-23)" xlinkhref="#path-22" />
              </g>
              <g id="Path-3-Copy" mask="url(#mask-18)">
                <use fill="#522E29" fillrule="evenodd" xlinkhref="#path-24" />
                <use fill="black" fillopacity={1} filter="url(#filter-25)" xlinkhref="#path-24" />
              </g>
              <g mask="url(#mask-18)">
                <use fill="url(#linearGradient-26)" fillrule="evenodd" xlinkhref="#path-28" />
                <use fill="url(#linearGradient-27)" fillrule="evenodd" xlinkhref="#path-28" />
                <use fill="black" fillopacity={1} filter="url(#filter-29)" xlinkhref="#path-28" />
              </g>
            </g>
            <ellipse id="Oval-7" fill="#784740" filter="url(#filter-30)" transform="translate(232.617761, 121.523618) rotate(-16.000000) translate(-232.617761, -121.523618) " cx="232.617761" cy="121.523618" rx="78.351" ry="37.375" />
          </g>
        </g>
      </g>
    </svg>
